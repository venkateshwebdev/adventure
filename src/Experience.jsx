...
const Experience = () => {
  ...
  return (
    ...
    <mesh position={[-130,1,-130]} scale={2} onClick={handleClick}>
      ...
      <Html style={{width:"300px"}} color="pink" position-y={1}>{!message?"Clik on this Block":"You Can go to the village Now find the village. Press the arrowDown button for 20 sec and go right"} </Html>
